...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _custom_students__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./custom/_students */ "./resources/js/custom/_students.js");
...
/* harmony import */ var _custom_Teachers_add__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./custom/Teachers-add */ "./resources/js/custom/Teachers-add.js");
...
/* harmony import */ var _custom_Password_Update__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./custom/Password_Update */ "./resources/js/custom/Password_Update.js");
/* harmony import */ var _custom_Password_Update__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_custom_Password_Update__WEBPACK_IMPORTED_MODULE_9__);
...
/***/ "./resources/js/custom/Add_Cohort.js":
/*!*******************************************!*\
  !*** ./resources/js/custom/Add_Cohort.js ***!
  \*******************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formData, saveResponse, result, errorHtml, field, tbody, newRow, startDate, endDate, yearRange;
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            for (field in result.errors) {
              errorHtml += "<p class=\"text-red-500\">".concat(result.errors[field][0], "</p>");
            }
            messageDiv.innerHTML = errorHtml;
            return _context.abrupt("return");
          case 16:
            messageDiv.innerHTML = "<p class=\"text-green-600\">".concat(result.message, "</p>");
            form.reset();
          ...
          case 27:
            ...
            messageDiv.innerHTML = "<p class=\"text-red-500\">Une erreur est survenue. Veuillez r\xE9essayer.</p>";
...
/***/ "./resources/js/custom/Cohort_edit.js":
/*!********************************************!*\
  !*** ./resources/js/custom/Cohort_edit.js ***!
  \********************************************/
/***/ (() => {
...
/***/ "./resources/js/custom/Password_Update.js":
/*!************************************************!*\
  !*** ./resources/js/custom/Password_Update.js ***!
  \************************************************/
/***/ (() => {
          ...
          case 10:
            ...
            if (data.errors) {
              for (key in data.errors) {
                html += "<p class=\"text-red-500\">".concat(data.errors[key][0], "</p>");
              }
            } else {
              html = "<p class=\"text-red-500\">".concat(data.message || 'Erreur inconnue', "</p>");
            }
            messageDiv.innerHTML = html;
            messageDiv.classList.remove('hidden');
            return _context.abrupt("return");
          case 17:
            messageDiv.innerHTML = "<p class=\"text-green-600\">".concat(data.message, "</p>");
            messageDiv.classList.remove('hidden');
            _context.next = 26;
            break;
          case 21:
            ...
            messageDiv.innerHTML = "<p class=\"text-red-500\">Erreur r\xE9seau ou serveur.</p>";
            messageDiv.classList.remove('hidden');
          case 26:
          case "end":
            return _context.stop();
...
/***/ "./resources/js/custom/Student_Update.js":
/*!***********************************************!*\
  !*** ./resources/js/custom/Student_Update.js ***!
  \***********************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var updateRoute = updateForm.dataset.updateRoute;
  var messageDiv = document.getElementById('responseMessage');
  updateForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formData, updateResponse, responseData, errorHtml, field;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
          ...
          case 10:
            ...
            if (responseData.errors) {
              for (field in responseData.errors) {
                errorHtml += "<p class=\"text-red-500\">".concat(responseData.errors[field][0], "</p>");
              }
            } else {
              errorHtml = "<p class=\"text-red-500\">".concat(responseData.message || 'Erreur inconnue.', "</p>");
            }
            messageDiv.innerHTML = errorHtml;
            messageDiv.classList.remove('hidden');
            return _context.abrupt("return");
          case 17:
            messageDiv.innerHTML = "<p class=\"text-green-600\">".concat(responseData.message, "</p>");
            messageDiv.classList.remove('hidden');
          ...
          case 22:
            _context.prev = 22;
            _context.t0 = _context["catch"](4);
            messageDiv.innerHTML = "<p class=\"text-red-500\">Erreur inattendue. Veuillez r\xE9essayer.</p>";
            messageDiv.classList.remove('hidden');
            console.error('Erreur AJAX :', _context.t0);
          case 27:
          case "end":
...
/***/ "./resources/js/custom/Teachers-add.js":
/*!*********************************************!*\
  !*** ./resources/js/custom/Teachers-add.js ***!
  \*********************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var saveRoute = form.dataset.saveRoute;
  var sendMailRoute = form.dataset.sendmailRoute;
  var messageDiv = document.getElementById('form-message');
  form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formData, firstName, lastName, name, email, saveResponse, errorData, errorHtml, field, mailRoute, mailResponse, result, tbody, newRow;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            ...
            email = formData.get('email'); // Route consultation for the method
            _context.prev = 8;
            _context.next = 11;
          ...
          case 15:
            ...
            errorHtml = '';
            for (field in errorData.errors) {
              errorHtml += "<p class=\"text-red-500\">".concat(errorData.errors[field][0], "</p>");
            }
            messageDiv.innerHTML = errorHtml;
            return _context.abrupt("return");
          case 20:
            // If the registration is successful, we send the email
            mailRoute = "{{ route('sendmail', ['name' => ':name', 'email' => ':email']) }}".replace(':name', encodeURIComponent(name)).replace(':email', encodeURIComponent(email));
            _context.next = 23;
            return fetch(sendMailRoute, {
              method: 'POST',
              headers: {
          ...
          case 23:
            ...
            messageDiv.innerHTML = "<p class=\"text-yellow-500\">Ensaignant enregistr\xE9, mais l'email n'a pas pu \xEAtre envoy\xE9.</p>";
            return _context.abrupt("return");
          case 27:
            _context.next = 29;
            return saveResponse.json();
          case 29:
            ...
            messageDiv.innerHTML = "<p class=\"text-green-600\">".concat(result.message, " Un email a \xE9t\xE9 envoy\xE9 \xE0 l'utilisateur.</p>");
            form.reset();
...
/***/ "./resources/js/custom/Teachers-edit.js":
/*!**********************************************!*\
  !*** ./resources/js/custom/Teachers-edit.js ***!
  \**********************************************/
/***/ (() => {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
// This script edit teacher information in the teacher list
document.addEventListener('DOMContentLoaded', function () {
...
/***/ "./resources/js/custom/_students.js":
/*!******************************************!*\
  !*** ./resources/js/custom/_students.js ***!
  \******************************************/
/***/ (() => {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
// This script get the information of the student and get email for send email to the student
document.addEventListener('DOMContentLoaded', function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 23:
            ...
            messageDiv.innerHTML = "<p class=\"text-yellow-500\">\xC9tudiant enregistr\xE9, mais l'email n'a pas pu \xEAtre envoy\xE9.</p>";
            return _context.abrupt("return");
          case 27:
            _context.next = 29;
            return saveResponse.json();
          case 29:
            ...
            tbody = document.querySelector('table[data-datatable-table="true"] tbody');
            newRow = document.createElement('tr');
            newRow.innerHTML = "\n                <td>".concat(lastName, "</td>\n                <td>").concat(firstName, "</td>\n                <td>").concat(email, "</td>\n                <td>").concat(new Date(formData.get('birth_date')).toLocaleDateString('fr-FR'), "</td>\n                <td>\n                    <div class=\"flex flex-col items-start space-y-2\">\n                        <a class=\"hover:text-primary cursor-pointer\" href=\"#\" data-modal-toggle=\"#student-modal\">\n                            <button class=\"btn btn-xs btn-primary w-20\">\n                                Modifier\n                            </button>\n                        </a>\n                        <a class=\"hover:text-primary cursor-pointer\" href=\"#\" data-modal-toggle=\"#Alert-modal\">\n                            <button class=\"btn btn-xs btn-danger w-20\">\n                                Supprimer\n                            </button>\n                        </a>\n                    </div>\n                </td>\n            ");
            tbody.appendChild(newRow);
            _context.next = 41;
            break;
          case 38:
